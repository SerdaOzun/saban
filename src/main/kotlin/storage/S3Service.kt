...
class S3Service(config: SabanConfig) : KoinComponent {
    private val pronunciationService by inject<PronunciationService>()
    ...
    suspend fun createLanguageBuckets() {
        pronunciationService.getLanguages()
            .filter { lang ->
                runCatching {
